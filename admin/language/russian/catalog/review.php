...
// Text
$_['text_success']      = 'Отзыв был изменен!';
...
$_['error_product']     = 'Продукт необходим!';
$_['error_author']      = 'Автор должен быть от 3 до 64 символов!';
$_['error_text']        = 'Текст отзыва должен содержать минимум 1 символ!';
$_['error_rating']      = 'Оценка требуется!';