...
$_['error_attribute']   = 'Эту группу атрибутов нельзя удалить, поскольку она назначена %s атрибутам!';
$_['error_product']     = 'Эту группу атрибутов нельзя удалить, поскольку она назначена %s продуктам!';